...
from unicorn_project.training.views_auth import ForcePasswordChangeView, forgot_password, custom_login, two_factor_auth, two_factor_setup, two_factor_verify, two_factor_disable, dismiss_2fa_prompt, dismiss_release_notes, regenerate_backup_codes, request_email_2fa_code
...
urlpatterns = [
    ...
    path('accounts/release-notes/dismiss/', dismiss_release_notes, name='dismiss_release_notes'),
